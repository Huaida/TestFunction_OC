...
@interface MZCustomNavigationBar()
...
@implementation MZCustomNavigationBar


+ (instancetype)CustomNavigationBar {
    MZCustomNavigationBar *navigationBar = [[self alloc] initWithFrame:CGRectMake(0, 0, MZ_SW, [MZCustomNavigationBar navBarBottom])];
...
-(void)updateFrame {
    ...
    self.rightButton.frame = CGRectMake(MZ_SW - buttonWidth - margin, top, buttonWidth, buttonHeight);
    self.titleLable.frame = CGRectMake((MZ_SW - titleLabelWidth) / 2, top, titleLabelWidth, titleLabelHeight);
    self.bottomLine.frame = CGRectMake(0, (CGFloat)(self.bounds.size.height-0.5), MZ_SW, 0.5);
}
